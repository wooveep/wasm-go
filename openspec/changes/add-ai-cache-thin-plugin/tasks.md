...
- [x] 8.7 Document billing interaction through trusted `upstream_invoked` facts without user-visible billing response fields.
- [x] 8.8 Mark existing online embedding/vector behavior as legacy or explicit non-production compatibility if it remains in code.
