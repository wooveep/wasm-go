# Graph Report - wasm-go  (2026-05-23)

## Corpus Check
- 135 files · ~107,935 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2864 nodes · 3463 edges · 205 communities (176 shown, 29 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 251 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d17ef3a`
...
Cohesion: 0.07
Nodes (60): TestBuiltinAttributesDefaultSource(), TestCompleteFlow(), TestConfigWithDefaultAttributes(), TestGetRouteAndClusterNameEdgeCases(), TestLegacyConfigCompatibility(), TestMetrics(), TestOnHttpRequestBody(), TestOnHttpRequestHeaders() (+52 more)
...
Cohesion: 0.06
Nodes (48): ChatMode, calculateCost(), ceilCost(), deniedMissingBalance(), deniedMissingIdentity(), deniedNoBalance(), getOperationMode(), int64Default() (+40 more)
...
Cohesion: 0.05
Nodes (42): ADDED Requirements, ai-billing-events Specification, MODIFIED Requirements, Purpose, Requirement: Billing event callouts are authenticated, Requirement: Billing event delivery is fail-open by default, Requirement: Billing events are generated per completed AI request, Requirement: Billing plugin configuration (+34 more)
...
Cohesion: 0.09
Nodes (24): Log, Critical(), Criticalf(), Debug(), Debugf(), Error(), Errorf(), Info() (+16 more)
...
Cohesion: 0.12
Nodes (25): BillingConfig, BillingEvent, BillingService, BillingUsage, billingUsageDetails(), buildBillingEvent(), deliverBillingEvent(), initBillingRequestContext() (+17 more)
...
Cohesion: 0.24
Nodes (9): init(), main(), onHttpRequestHeaders(), parseConfig(), SafeLogHttpCallConfig, ClusterClient, NewClusterClient(), HttpClient (+1 more)

### Community 70 - "Community 70"
Cohesion: 0.21
Nodes (10): isBillingDeliveryAcceptedStatus(), isBillingDeliveryFailureStatus(), sendBillingEvent(), statusCodeFromHeaders(), TestBillingDeliveryAcceptedStatusExcludesAuthFailures(), TestBillingDeliveryFailureStatusClassification(), TestBillingEventDelivery(), TestParseConfig() (+2 more)
...
Cohesion: 0.18
Nodes (10): 14. 对账与补偿, 15. 安全要求, 16. 验收标准, 1. 背景, 2. 总体职责, 3. 数据归属, code:text (console UI), code:text (account_balance = sum(billing_statements)) (+2 more)
...
## Knowledge Gaps
- **1351 isolated node(s):** `RuleConfig[PluginConfig]`, `ResponseCallback`, `HttpClient`, `ClusterClient`, `Log` (+1346 more)
...
- **Why does `UnsafeInfof()` connect `Community 13` to `Community 10`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `compileWasm()` connect `Community 0` to `Community 1`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `HttpCall()` connect `Community 13` to `Community 0`, `Community 68`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 42 inferred relationships involving `NewTestHost()` (e.g. with `TestHttpCall()` and `TestRebuildExample()`) actually correct?**
