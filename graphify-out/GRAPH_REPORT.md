...
## Corpus Check
- 151 files · ~126,455 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3130 nodes · 3841 edges · 235 communities (207 shown, 28 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 304 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5425ba15`
...
## Communities (235 total, 28 thin omitted)
...
Cohesion: 0.06
Nodes (43): BillingConfig, BillingEvent, BillingFact, BillingService, BillingUsage, billingUsageDetails(), buildBillingEvent(), deliverBillingEvent() (+35 more)
...
Cohesion: 0.16
Nodes (20): Log, Critical(), Criticalf(), Debug(), Debugf(), Error(), Errorf(), Info() (+12 more)
...
Cohesion: 0.23
Nodes (13): init(), init(), init(), init(), ParseOverrideConfig(), ParseOverrideConfigBy(), ProcessRequestBody(), ProcessRequestHeaders() (+5 more)
...
Cohesion: 0.15
Nodes (13): Requirement: Billing events are generated per completed AI request, Scenario: Consumer is sourced from configured consumer header, Scenario: Each AI request gets a new event identity, Scenario: Event identity is generated by the billing plugin, Scenario: Non-emitted identity and cost fields are excluded, Scenario: Retry reuses idempotency key, Scenario: Rule-level provider is emitted, Scenario: Rule-level quota scope is emitted (+5 more)
...
Cohesion: 0.17
Nodes (12): code:yaml (provider:), code:yaml (provider:), code:yaml (provider:), code:json ({), code:yaml (provider:), code:shell (curl --location 'http://<your higress domain>/v1/chat/comple), code:json ({), 使用 OpenAI 协议代理混元服务 (+4 more)
...
Cohesion: 0.29
Nodes (9): isBillingDeliveryAcceptedStatus(), isBillingDeliveryFailureStatus(), deliverTestBillingEvent(), mustBillingConfig(), requireObjectFactName(), TestBillingDeliveryAcceptedStatusExcludesAuthFailures(), TestBillingDeliveryFailureStatusClassification(), TestBillingEventDelivery() (+1 more)
...
Cohesion: 0.22
Nodes (5): ADDED Requirements, MODIFIED Requirements, Requirement: Billing event callouts are authenticated, Scenario: Billing event callout includes Bearer token, Scenario: Documentation examples do not expose secrets
...
Cohesion: 0.22
Nodes (8): ai-billing-events Specification, Purpose, Requirement: Billing plugin does not mutate account balance, Requirement: Billing plugin is independent from quota and statistics plugins, Requirements, Scenario: Event is accepted, Scenario: Quota plugin is disabled, Scenario: Statistics plugin is disabled

### Community 116 - "Community 116"
Cohesion: 0.22
Nodes (8): ADDED Requirements, Requirement: Error behavior compatibility, Requirement: Realm response header, Scenario: Configured realm is used, Scenario: Default realm is used, Scenario: Missing credential is rejected, Scenario: Unauthorized consumer is rejected, Scenario: Unknown credential is rejected
...
## Knowledge Gaps
- **1491 isolated node(s):** `RuleConfig[PluginConfig]`, `ResponseCallback`, `HttpClient`, `ClusterClient`, `Log` (+1486 more)
...
- **Why does `contains()` connect `Community 0` to `Community 1`, `Community 3`, `Community 36`, `Community 8`, `Community 47`, `Community 50`, `Community 84`, `Community 85`, `Community 118`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `redisCallInternal()` connect `Community 1` to `Community 0`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `UnsafeInfof()` connect `Community 39` to `Community 8`, `Community 3`?**
