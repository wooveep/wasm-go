# Graph Report - wasm-go  (2026-05-19)

## Corpus Check
- 125 files · ~100,409 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2664 nodes · 3087 edges · 201 communities (173 shown, 28 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 239 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68681512`
...
4. `NewTestHost()` - 43 edges
5. `CommonHttpCtx[PluginConfig]` - 41 edges
6. `RunTest()` - 39 edges
7. `提供商特有配置` - 32 edges
8. `用法示例` - 29 edges
9. `TestHost` - 27 edges
10. `Console Billing Service API 设计规范` - 17 edges
...
Cohesion: 0.05
Nodes (82): TestBillingEventDelivery(), TestParseConfig(), quotaConfigWith(), TestMissingPriceScriptResult(), TestMonetaryDeduction(), TestParseConfig(), TestRequestAdmission(), TestBuiltinAttributesDefaultSource() (+74 more)
...
Cohesion: 0.07
Nodes (32): ChatMode, calculateCost(), ceilCost(), deniedMissingBalance(), deniedMissingIdentity(), deniedNoBalance(), getOperationMode(), int64Default() (+24 more)
...
Cohesion: 0.14
Nodes (19): BillingConfig, BillingEvent, BillingService, buildBillingEvent(), deliverBillingEvent(), int64FromContext(), intDefault(), intFromContext() (+11 more)
...
Cohesion: 0.18
Nodes (15): init(), init(), init(), init(), init(), onHttpRequestBody(), parseConfig(), RequestBlockConfig (+7 more)

### Community 43 - "Community 43"
Cohesion: 0.14
Nodes (7): Log, Debug(), Debugf(), Info(), Infof(), UnsafeInfo(), UnsafeInfof()
...
Cohesion: 0.13
Nodes (14): Apply WasmPlugin API, Build on local yourself, code:bash (cd examples/request-block), code:Dockerfile (FROM scratch), code:bash (docker build -t <your_registry_hub>/request-block:1.0.0 -f <), code:yaml (apiVersion: extensions.higress.io/v1alpha1), code:bash (curl <your_gateway_address>/api/user/swagger.html), code:text (HTTP/1.1 403 Forbidden) (+6 more)
...
Cohesion: 0.18
Nodes (7): parseConfig(), parseConfig(), SafeLogHttpCallConfig, ClusterClient, NewClusterClient(), HttpClient, ResponseCallback

### Community 72 - "Community 72"
Cohesion: 0.2
Nodes (4): completeConfig, customConfig, parseConfig(), parseConfigWithError()
...
Cohesion: 0.4
Nodes (3): init(), parseConfig(), RebuildConfig

### Community 121 - "Community 121"
Cohesion: 0.4
Nodes (4): HttpCallConfig, init(), onHttpRequestHeaders(), parseConfig()

### Community 122 - "Community 122"
Cohesion: 0.4
Nodes (4): HttpCallConfig, busyLoop(), onHttpRequestHeaders(), TestBusyLoopLinearity()

### Community 123 - "Community 123"
Cohesion: 0.4
Nodes (3): TestParseOverrideConfig(), TestParseRuleConfig(), TestRuleLevelConfigIsolation()
...
## Knowledge Gaps
- **1304 isolated node(s):** `options`, `headers`, `HttpCallConfig`, `HttpCallConfig`, `RebuildConfig` (+1299 more)
...
- **Why does `recoverFunc()` connect `Community 11` to `Community 0`, `Community 1`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `UnsafeInfof()` connect `Community 43` to `Community 58`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `SetPluginLog()` connect `Community 152` to `Community 43`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 41 inferred relationships involving `NewTestHost()` (e.g. with `TestHttpCall()` and `TestRebuildExample()`) actually correct?**
  _`NewTestHost()` has 41 INFERRED edges - model-reasoned connections that need verification._
